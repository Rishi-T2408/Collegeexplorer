...
if(isset($_POST['search']))
{
   ...
   $query ="SELECT * FROM csabround1 WHERE RoundNo='$RoundNo' AND Institute='$Institute' AND Category='$Category' AND SeatPool='$SeatPool' UNION ALL SELECT * FROM csabround2 WHERE RoundNo='$RoundNo' AND Institute='$Institute' AND Category='$Category' AND SeatPool='$SeatPool'";
