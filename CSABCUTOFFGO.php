...
<html  lang="en-US">
	...
	<body>
		...
		<!-- Heading -->
			<div id="heading" >
				<h1>CUTOFF-CSAB(SPECIAL ROUND)</h1>
			</div>
...
if(isset($_POST['search']))
{
  ...
  $query ="SELECT * FROM csabround1 WHERE RoundNo='$RoundNo' AND Institute='$Institute' AND Quota='$Quota' AND Category='$Category' AND SeatPool='$SeatPool' UNION ALL SELECT * FROM csabround2 WHERE RoundNo='$RoundNo' AND Institute='$Institute' AND Quota='$Quota' AND Category='$Category' AND SeatPool='$SeatPool' ";
